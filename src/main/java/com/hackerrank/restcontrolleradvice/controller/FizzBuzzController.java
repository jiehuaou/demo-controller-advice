...
public class FizzBuzzController {
  ...
  public ResponseEntity<FizzBuzzResponse> getFizzBuzzResponse(@PathVariable("code") String code)
    ...
    FizzBuzzResponse body = new FizzBuzzResponse("Successfully completed fizzbuzz test",
            200);
    ResponseEntity<FizzBuzzResponse> resp = new ResponseEntity<FizzBuzzResponse>(body,
            HttpStatus.OK);
    return resp;
//    return null;
  }
